...
$sql = "SELECT * FROM tbl_teacher where temail ='".$text_email."' " ;
$ans = $conn->query($sql);
$res=mysqli_fetch_array($ans);
  $realemail=$res['temail'];
  $person_fname=$res['tfname'];  
  $person_lname=$res['tlname'];
...
$sql = "UPDATE tbl_teacher SET password ='$otp_pass' WHERE temail='$text_email'";
$ans1 = $conn->query($sql);
