...
$sql = "SELECT * FROM tbl_student where semail ='".$text_email."' " ;
$ans = $conn->query($sql);
$res=mysqli_fetch_array($ans);
  $realemail=$res['semail'];
  $person_fname=$res['sfname'];  
  $person_lname=$res['slname'];
...
$sql = "UPDATE tbl_student SET password ='$otp_pass' WHERE semail='$text_email'";
$ans1 = $conn->query($sql);
...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="student.php"><button class="button button--success" data-for="js_success-popup">OK</button></a>
    </p>
  </div>
</div>
<?php } } else { ?>
